...
axios.interceptors.response.use(response => {
    ...
    const refreshToken = response.headers.freshtoken;
    const token = response.headers.authorization;
    // console.log('Response Headers token:', response.headers.authorization); // 打印响应头部数据
    // console.log('Response Headers freshToken:', response.headers.freshtoken); // 打印响应头部数据
